...
***NOTE FOR POTENTIAL USERS: improvements to the assimilation algorithm are currently being developed offline -- in the meantime, everything still works fine..! Comments/suggestions/feedback always welcome...***
...
One example of a potential configuration of the model and assimilation algorithm using this framework is detailed in chapter 6 of Kent (2017), and provides the basis for the source code available here. This framework has been developed further and will be reported in Kent et al. (2020).

## References
* Kent, T. (2017) An idealised fluid model of Numerical Weather Prediction: dynamics and data assimilation. *PhD thesis, University of Leeds*. Available at [http://etheses.whiterose.ac.uk/17269/](http://etheses.whiterose.ac.uk/17269/).
...
* *'The modRSW model -- physical basis, numerics, and dynamics'*, DA workshop, Leeds, May 2019. [Slides](http://www1.maths.leeds.ac.uk/~amttk/files/workshop/Kent_DAworkshop_may2019.pdf).

* *'Idealised forecast-assimilation experiments and their relevance for convective-scale Numerical Weather Prediction'*, EGU General Assembly, Vienna, April 2019. [Slides](http://www1.maths.leeds.ac.uk/~amttk/files/egu2019_DA.pdf).

## Workshop

In May 2019, Luca Cantarello and I hosted a research workshop for current and potential users of the modRSW model in data assimilation research. See [workshop website](http://www1.maths.leeds.ac.uk/~amttk/workshop.html) for more info, including schedule and presentations. 
